...
classes = pd.read_csv('classes_proj.csv', index_col=0)['class']
...
# ---------------
# Task 8: Now, fit the classifier with the first two faetures of the original data matrix and generate a score. Notice the large difference in scores!
# ---------------
