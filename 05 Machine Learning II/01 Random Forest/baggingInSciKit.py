...
print('Accuracy score of Bagged Classifier, 10 estimators:', bag_accuracy)
...
print('Accuracy score of Bagged Classifier, 10 estimators, 10 max features:', bag_accuracy_10)
...
print('Accuracy score of Logistic Regression, 10 estimators:', bag_accuracy_lr)
